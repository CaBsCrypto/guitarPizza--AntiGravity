...
import { a6 as ee, a7 as te, a2 as G, U as $, V as y, X as h, a8 as ie, a9 as d, Z as p, aa as re, T as L, Y as j, __tla as __tla_0 } from "./core-D7slzEvJ.js";
import { gR as c, __tla as __tla_1 } from "./index-BaKN6Yt3.js";
let S, C, Be, je, s, R, lt, De;
let __tla = Promise.all([
    ...
    S = {
        ...
        generateAvatarColors (e) {
            const i = e.toLowerCase().replace(/^0x/iu, "").replace(/[^a-f0-9]/gu, "").substring(0, 6).padEnd(6, "0"), o = this.hexToRgb(i), n = getComputedStyle(document.documentElement).getPropertyValue("--w3m-border-radius-master"), a = 100 - 3 * Number(n?.replace("px", "")), l = `${a}% ${a}% at 65% 40%`, u = [];
            for(let v = 0; v < 5; v += 1){
   ...
   `;
        ...
        hexToRgb (e) {
            const t = parseInt(e, 16), i = t >> 16 & 255, o = t >> 8 & 255, n = t & 255;
            return [
                i,
                o,
                n
        ...
        tintColor (e, t) {
            const [i, o, n] = e, r = Math.round(i + (255 - i) * t), a = Math.round(o + (255 - o) * t), l = Math.round(n + (255 - n) * t);
            return [
                r,
                a,
                l
        ...
        maskInput ({ value: e, decimals: t, integers: i }) {
            if (e = e.replace(",", "."), e === D) return `0${D}`;
            const [o = "", n] = e.split(D).map((P)=>P.replace(/[^0-9]/gu, "")), r = i ? o.substring(0, i) : o, a = r.length === 2 ? String(Number(r)) : r, l = typeof t == "number" ? n?.substring(0, t) : n, u = typeof t != "number" || t > 0;
    ...
    C = function(e) {
        return function(i) {
            return typeof i == "function" ? ne(e, i) : oe(e, i);
        };
    };
    const ae = {
        attribute: !0,
        ...
        if (r === void 0 && globalThis.litPropertyMetadata.set(n, r = new Map), o === "setter" && ((e = Object.create(e)).wrapped = !0), r.set(i.name, e), o === "accessor") {
            const { name: a } = i;
            return {
                set (l) {
                    const u = t.get.call(this);
                    t.set.call(this, l), this.requestUpdate(a, u, e, !0, l);
                },
                init (l) {
        ...
        if (o === "setter") {
            ...
            return function(l) {
                const u = this[a];
                t.call(this, l), this.requestUpdate(a, u, e, !0, l);
            };
        }
        throw Error("Unsupported decorator location: " + o);
    };
    s = function(e) {
        return (t, i)=>typeof i == "object" ? le(e, t, i) : ((o, n, r)=>{
...
`;
    var m = function(e, t, i, o) {
        var n = arguments.length, r = n < 3 ? t : o === null ? o = Object.getOwnPropertyDescriptor(t, i) : o, a;
        if (typeof Reflect == "object" && typeof Reflect.decorate == "function") r = Reflect.decorate(e, t, i, o);
        else for(var l = e.length - 1; l >= 0; l--)(a = e[l]) && (r = (n < 3 ? a(r) : n > 3 ? a(t, i, r) : a(t, i)) || r);
    ...
    const K = Symbol.for(""), ce = (e)=>{
        if (e?.r === K) return e?._$litStatic$;
            ...
            let u, v = 0, P = !1;
            for(; v < o;){
                for(u = t[v]; v < o && (r = i[v], (n = ce(r)) !== void 0);)u += n + t[++v], P = !0;
                v !== o && l.push(r), a.push(u), v++;
            }
            if (v === o && a.push(t[o]), P) {
                const q = a.join("$$lit$$");
                (t = X.get(q)) === void 0 && (a.raw = a, X.set(q, t = a)), i = l;
            }
            return e(t, ...i);
        }, Y = de(h), pe = d`<svg width="30" height="30" viewBox="0 0 30 30" fill="none">
...
`;
    ...
    const Oe = {
        ...
        "ph-warning": ()=>c(()=>import("./PhWarning-CpkID9oi.js"), __vite__mapDeps([49,1])),
        "ph-warning-circle": ()=>c(()=>import("./PhWarningCircle-Cm58gXb9.js"), __vite__mapDeps([50,1])),
        "ph-x": ()=>c(()=>import("./PhX-C3b4cCEy.js"), __vite__mapDeps([51,1]))
    }, Me = {
        appStore: pe,
        apple: ue,
        bitcoin: ge,
        ...
        twitterIcon: ke,
        walletConnect: Ae,
        walletConnectInvert: Ie,
        walletConnectBrown: Ve,
        walletConnectLightBrown: He,
        x: J,
        wallet: ze
    }, Ze = {
    ...
    const We = Be(class extends je {
        ...
        update(e, [t]) {
            if (this.st === void 0) {
                this.st = new Set, e.strings !== void 0 && (this.nt = new Set(e.strings.join(" ").split(/\s/).filter((o)=>o !== "")));
...
`;
    ...
    let B = class extends y {
        ...
        render() {
            const t = this.walletImages.length < U;
...
`;
    ...
    let H = class extends y {
        ...
        render() {
            ...
            const t = this.size === "md" ? "md-medium" : "sm-medium", i = this.size === "md" ? "md" : "sm";
            return h`
...
export { S as U, C as c, Be as e, je as i, s as n, R as o, lt as r, De as t, __tla };
