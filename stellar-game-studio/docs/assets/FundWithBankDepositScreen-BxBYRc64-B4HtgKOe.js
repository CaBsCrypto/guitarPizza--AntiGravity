import{gO as I,fq as F,im as m,jb as P,d3 as A,gN as t,a0 as z,h7 as D,g3 as v}from"./index-C4LYSIxf.js";import{h as V}from"./CopyableText-CQapvaMr-fEIkhQ9L.js";import{n as C}from"./ScreenLayout-BZAQ9cdJ-BhCHOWxj.js";import{t as q}from"./InfoBanner-Jwk3Xf3U-C6ohEv1j.js";import{w as M,c as R,p as Y}from"./SelectSourceAsset-MkkjreKe-CMTFmYEb.js";import{c as H}from"./createLucideIcon-CTS3d18V.js";import{H as N}from"./hourglass-B91qXyiJ.js";import{C as O}from"./check-B2TEpPX-.js";import{C as S}from"./circle-x-CxNpH6BD.js";import"./copy-DyTc93Jq.js";import"./ModalFooter-FDXOM0ZR-CPwb0VG7.js";import"./Screen-C5Cvq4cJ-TWWejrhf.js";import"./index-Dq_xe9dz-20rrLqGp.js";import"./chevron-down-BehP9pBJ.js";const K=[["path",{d:"m16 11 2 2 4-4",key:"9rsbq5"}],["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]],X=H("user-check",K),G=e=>{try{return e.location.origin}catch{return}},J=({data:e,onClose:i})=>t.jsx(C,{showClose:!0,onClose:i,title:"Initiate bank transfer",subtitle:"Use the details below to complete a bank transfer from your bank.",primaryCta:{label:"Done",onClick:i},watermark:!1,footerText:"Exchange rates and fees are set when you authorize and determine the amount you receive. You'll see the applicable rates and fees for your transaction separately",children:t.jsx(Q,{children:(z[e.deposit_instructions.asset]||[]).map((([u,f],y)=>{let d=e.deposit_instructions[u];if(!d||Array.isArray(d))return null;let r=u==="asset"?d.toUpperCase():d,g=r.length>100?`${r.slice(0,9)}...${r.slice(-9)}`:r;return t.jsxs(Z,{children:[t.jsx(ee,{children:f}),t.jsx(V,{value:r,includeChildren:D.isMobile,children:t.jsx(te,{children:g})})]},y)}))})});let Q=v.ol`
