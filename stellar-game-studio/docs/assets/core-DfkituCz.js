const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BY1WiGDS.js","assets/index-D1Ugr-Fq.js","assets/index-BA_XtR5V.css","assets/parseSignature-3-V4kYbj.js","assets/ccip-BvSxjgvk.js","assets/secp256k1-DfL03jW3.js","assets/features-CuhZosgU.js","assets/basic-CDVEFv-9.js","assets/index-CMiw5zmw.js","assets/browser-Baxqii8z.js","assets/w3m-modal-8UAy0VZ-.js"])))=>i.map(i=>d[i]);
import { bw as Mp, aX as jp, b8 as Fp, it as qp, V as Wp, iu as Hp, c0 as uu, gR as jr, bQ as ui, iv as Ya, gQ as hu, iw as Fr, ix as or, iy as Vp, iz as Dt, iA as yt, iB as z, iC as Ts, iD as zp, iE as Kp, iF as xr, iG as ia, iH as ar, iI as Gp, iJ as Yp, iK as Jp, iL as Xp, iM as Nn, iN as Zp, iO as Qp, iP as ts, iQ as cr, iR as Ja, iS as ef, iT as Xa, iU as Za, iV as qr, iW as Qa, iX as Sc, iY as tf, iZ as sf, i_ as Tc, i$ as hn, j0 as pu, j1 as gs, j2 as es, j3 as Ps, j4 as fu, h as hi, cY as Oc, __tla as __tla_0 } from "./index-D1Ugr-Fq.js";
    ...
    async function jc() {
        if (!No) {
            const { createPublicClient: t, http: e, defineChain: s } = await jr(async ()=>{
                const { createPublicClient: n, http: r, defineChain: i } = await import("./index-BY1WiGDS.js");
                return {
...
`);
    ...
    async function Mm({ hash: t, signature: e }) {
        const s = Vr(t) ? t : ga(t), { secp256k1: n } = await jr(async ()=>{
            const { secp256k1: o } = await import("./secp256k1-DfL03jW3.js");
            return {
                secp256k1: o
            };
...
`;
        ...
        async initialize(e) {
            if (this.initializeProjectSettings(e), this.initControllers(e), await this.initChainAdapters(), this.sendInitializeEvent(e), x.state.enableReconnect ? (await this.syncExistingConnection(), await this.syncAdapterConnections()) : await this.unSyncExistingConnection(), this.remoteFeatures = await GN.fetchRemoteFeatures(e), x.setRemoteFeatures(this.remoteFeatures), this.remoteFeatures.onramp && ha.setOnrampProviders(this.remoteFeatures.onramp), (x.state.remoteFeatures?.email || Array.isArray(x.state.remoteFeatures?.socials) && x.state.remoteFeatures?.socials.length > 0) && await this.checkAllowedOrigins(), x.state.features?.reownAuthentication || x.state.remoteFeatures?.reownAuthentication) {
                const { ReownAuthentication: s } = await jr(async ()=>{
                    const { ReownAuthentication: r } = await import("./features-CuhZosgU.js");
                    return {
    ...
    class Lp extends YN {
        ...
        async injectModalUi() {
            if (!du && J.isClient()) {
                if (await jr(()=>import("./basic-CDVEFv-9.js"), __vite__mapDeps([7,8,1,2,9])), await jr(()=>import("./w3m-modal-8UAy0VZ-.js"), __vite__mapDeps([10,8,1,2])), !document.querySelector("w3m-modal")) {
