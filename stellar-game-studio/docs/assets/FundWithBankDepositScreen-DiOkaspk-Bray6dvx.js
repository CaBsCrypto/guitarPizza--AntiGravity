import{fq as B,es as F,gK as m,hp as P,fp as t,h$ as z,fI as D,eN as v}from"./index-BR4Qfvo1.js";import{p as V}from"./CopyableText-ChtfBWx4-CEjRDLRL.js";import{n as C}from"./ScreenLayout-DXc2tOGB-7ArMG6DQ.js";import{i as q}from"./InfoBanner-DkQEPd77-C-quF_AJ.js";import{y as M,c as R,p as Y}from"./SelectSourceAsset-B1U6GKed-CwFdjrWR.js";import{r as A}from"./chevron-down-DLim-u4e.js";import{c as H}from"./createLucideIcon-D4oxk5XH.js";import{H as K}from"./hourglass-D8B3cfL1.js";import{C as N}from"./check-AjXQG5cw.js";import{C as S}from"./circle-x-SbUxw_3b.js";import"./copy-BixS4kQg.js";import"./ModalHeader-BEW0Qv0H-BWCcJsDR.js";import"./Screen-BpvoV6mG-CPkobwQX.js";import"./index-Dq_xe9dz-CHcRlSQu.js";const O=[["path",{d:"m16 11 2 2 4-4",key:"9rsbq5"}],["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]],X=H("user-check",O),G=e=>{try{return e.location.origin}catch{return}},J=({data:e,onClose:i})=>t.jsx(C,{showClose:!0,onClose:i,title:"Initiate bank transfer",subtitle:"Use the details below to complete a bank transfer from your bank.",primaryCta:{label:"Done",onClick:i},watermark:!1,footerText:"Exchange rates and fees are set when you authorize and determine the amount you receive. You'll see the applicable rates and fees for your transaction separately",children:t.jsx(Q,{children:(z[e.deposit_instructions.asset]||[]).map((([u,f],y)=>{let d=e.deposit_instructions[u];if(!d||Array.isArray(d))return null;let r=u==="asset"?d.toUpperCase():d,h=r.length>100?`${r.slice(0,9)}...${r.slice(-9)}`:r;return t.jsxs(Z,{children:[t.jsx(ee,{children:f}),t.jsx(V,{value:r,includeChildren:D.isMobile,children:t.jsx(te,{children:h})})]},y)}))})});let Q=v.ol`
