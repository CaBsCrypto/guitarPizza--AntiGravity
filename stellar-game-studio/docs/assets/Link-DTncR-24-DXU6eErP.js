import{gN as s,g3 as d}from"./index-C4LYSIxf.js";let c=d.a`
  && {
...
`;const p=({size:e="md",variant:r="navigation",disabled:o=!1,as:i,children:a,onClick:t,...l})=>s.jsx(c,{as:i,$size:e,$variant:r,$disabled:o,onClick:n=>{o?n.preventDefault():t?.(n)},...l,children:a});export{p as n};
