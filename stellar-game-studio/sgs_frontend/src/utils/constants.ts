...
const TESTNET_CONTRACT_IDS: Record<string, string> = {
  ...
  'slice-token':       'CDDYOTZUTLLEQST7VVQPUL3XVXJERHQGJ246SA2RWCRROOQQPQKJTGZC',
  ...
  'refrigerator-vault': 'CDREFRIGERATORVAULTCONTRACTID3333333333333333333333333',
  'pizza-baking': 'CDPIZZABAKINGCONTRACTID333333333333333333333333333333333',
};
