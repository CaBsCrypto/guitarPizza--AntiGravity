import{gO as I,fq as F,im as m,jb as P,d3 as A,gN as t,a0 as z,h7 as D,g3 as v}from"./index-BKcGbtoC.js";import{h as V}from"./CopyableText-CQapvaMr-D5mzzQ63.js";import{n as C}from"./ScreenLayout-BZAQ9cdJ-D-5lkAVb.js";import{t as q}from"./InfoBanner-Jwk3Xf3U-6dp_n6Cq.js";import{w as M,c as R,p as Y}from"./SelectSourceAsset-MkkjreKe-B7cDfSkU.js";import{c as H}from"./createLucideIcon-BIy8paMS.js";import{H as N}from"./hourglass-kKzKvbJc.js";import{C as O}from"./check-BLOvfdAR.js";import{C as S}from"./circle-x-BRkB_q0X.js";import"./copy-DMSmmBkE.js";import"./ModalFooter-FDXOM0ZR-Dfzjob0s.js";import"./Screen-C5Cvq4cJ-DJxWFBIB.js";import"./index-Dq_xe9dz-BPSU1IVD.js";import"./chevron-down-C1e6Ik4T.js";const K=[["path",{d:"m16 11 2 2 4-4",key:"9rsbq5"}],["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]],X=H("user-check",K),G=e=>{try{return e.location.origin}catch{return}},J=({data:e,onClose:i})=>t.jsx(C,{showClose:!0,onClose:i,title:"Initiate bank transfer",subtitle:"Use the details below to complete a bank transfer from your bank.",primaryCta:{label:"Done",onClick:i},watermark:!1,footerText:"Exchange rates and fees are set when you authorize and determine the amount you receive. You'll see the applicable rates and fees for your transaction separately",children:t.jsx(Q,{children:(z[e.deposit_instructions.asset]||[]).map((([u,f],y)=>{let d=e.deposit_instructions[u];if(!d||Array.isArray(d))return null;let r=u==="asset"?d.toUpperCase():d,g=r.length>100?`${r.slice(0,9)}...${r.slice(-9)}`:r;return t.jsxs(Z,{children:[t.jsx(ee,{children:f}),t.jsx(V,{value:r,includeChildren:D.isMobile,children:t.jsx(te,{children:g})})]},y)}))})});let Q=v.ol`
